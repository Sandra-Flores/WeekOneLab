...
**Tumbleh** is a photo browsing app using the [The Tumblr API](https://www.tumblr.com/docs/en/api/v2#posts).
...
1. How to fix the images to make them look nicer and not too stretched out
2. Adding a better look to the application overall

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/hyxV4QU.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
